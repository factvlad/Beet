...
// container.innerHTML = "<p> Some Text11111 </p>"

import "./styles/main.scss"


// import "../node_modules/jquery/dist/jquery"
import "./js/jquery.social-buttons.min.js";
import "../node_modules/isotope-layout/dist/isotope.pkgd";
import "../node_modules/animsition/dist/js/animsition";
import "../node_modules/flexslider/2.6.2/jquery.flexslider";
import "../node_modules/wow.js/dist/wow.js"
import "../node_modules/smoothscroll/smoothscroll";
//import "./js/main";
...
const images = importAll(require.context('./img', false, /\.(png|ico|jpe?g|svg)$/));
...
(function ($) {
    $(window).on('load', function () {
        ...
        let anim = $(".animsition")
        anim.css("animation-duration", "1.1s")
        anim.css("opacity", "1")
        if (anim.length) {
            anim.animsition({
